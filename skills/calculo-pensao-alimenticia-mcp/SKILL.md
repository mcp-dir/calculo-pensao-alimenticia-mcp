---
name: calculo-pensao-alimenticia-mcp
description: Cálculo de pensão alimentícia: converta pensão fixada em salários mínimos para o valor vigente e atualize parcelas atrasadas com correção e juros. Use quando o usuário pedir o valor atual da pensão ou o total de atrasados.
---

# Cálculo de Pensão Alimentícia — REST API skill

Você tem acesso à **Cálculo de Pensão Alimentícia** REST API na MCP.AI.
...
Este MCP também funciona via **conexão MCP** (Claude / Cursor) em `https://api.mcp.ai/p_calculo-pensao-alimenticia` — veja o [README](../../README.md). A skill acima é pra consumir a **REST API** direto (agente próprio / código).
