...
### Pensão em salários mínimos e atualização de atrasados, para IA

**Cálculo de pensão alimentícia** para IA. Converta pensão fixada em salários mínimos para o valor vigente e atualize parcelas em atraso com correção e juros. Salário mínimo e índices ao vivo, sem login.

- 👨‍👩‍👧 **Converte pensão** em salários mínimos e atualiza atrasados
...
**Manual** (se o deeplink não abrir): [claude.ai/customize/connectors](https://claude.ai/customize/connectors?surface=cowork) → **+** → **Adicionar conector personalizado** → cole **Nome** `Cálculo de Pensão Alimentícia` e **URL** `https://api.mcp.ai/p_calculo-pensao-alimenticia`.

### Cursor

[➕ Instalar Cálculo de Pensão Alimentícia no Cursor](cursor://anysphere.cursor-deeplink/mcp/install?name=calculopensaoalimenticia&config=eyJ1cmwiOiJodHRwczovL2FwaS5tY3AuYWkvcF9jYWxjdWxvLXBlbnNhby1hbGltZW50aWNpYSJ9)

### VS Code (Copilot Chat)

[➕ Instalar Cálculo de Pensão Alimentícia no VS Code](vscode:mcp/install?name=calculopensaoalimenticia&config=%7B%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fapi.mcp.ai%2Fp_calculo-pensao-alimenticia%22%7D)
...
```
Converta uma pensão de 30% do salário mínimo para o valor de hoje
Atualize 6 parcelas de pensão em atraso com correção e juros
```
...
- 📧 [calculopensaoalimenticia@mcp.ai](mailto:calculopensaoalimenticia@mcp.ai)
- 🐛 [GitHub Issues](https://github.com/mcp-dir/calculo-pensao-alimenticia-mcp/issues)
- 📄 [docs/](docs/)
...
MIT — veja [LICENSE](LICENSE). O servidor MCP em `api.mcp.ai/p_calculo-pensao-alimenticia` é proprietário (hosted); este repositório (manifestos, docs, skills) é MIT.
